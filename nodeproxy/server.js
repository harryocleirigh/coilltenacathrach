...
// middleware proxies
app.use('/node/trees', cacheMiddleware(360000));
...
app.use('/node/singletree', createProxyMiddleware({ target: 'http://backend:5000', pathRewrite: { '^/node/singletree': '/singletree' }, changeOrigin: true }));
